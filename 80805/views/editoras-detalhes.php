    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1 text-white"><?php echo $buscarEditoraId["nome"];?></h1>
            </div>
        </header>
        <!-- Body -->
        <div class="container">
            <h1 class="mt-5 mb-3">Detalhes</h1>
            <p>Endereço: <?php echo $buscarEditoraId["endereco"];?></p>
            <p>Cidade: <?php echo $buscarEditoraId["cidade"];?></p>
            <p>Email: <?php echo $buscarEditoraId["email"];?></p>
            <p>Telefone: <?php echo $buscarEditoraId["telefone"];?></p>
        </div>
        <div class="container">
            <h1 class="mt-5 mb-3">Livros</h1>
            <?php
