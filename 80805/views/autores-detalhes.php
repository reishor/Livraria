    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1 text-white"><?php echo $buscarAutorId["nome"];?></h1>
            </div>
        </header>
        <!-- Body -->
        <div class="container">
            <h1 class="mt-5 mb-3">Detalhes</h1>
            <p>Nome: <?php echo $buscarAutorId["nome"];?></p>
            <p>Email: <?php echo $buscarAutorId["email"];?></p>
            <p>Formação: <?php echo $buscarAutorId["formacao"];?></p>
            <p>Foto: <?php echo $buscarAutorId["foto"];?></p>
        </div>
        <div class="container">
