    ...
    <body id="page-top">
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1 text-white">Editoras</h1>
                <?php
                if(isset($_GET["cadastro"])){
                    if($_GET["cadastro"] == "success"){
                        echo "<div class='alert alert-success' role='alert'>Editora cadastrada com sucesso</div>";
                    }else{
                        echo "<div class='alert alert-danger' role='alert'>Falha ao cadastrar editora</div>";
                    }
                }
                ?>
            </div>
        ...
        <!-- Body -->
        <div class="container">
            <h1 class="mt-5">Cadastrar nova editora</h1>
            <form action="editoras.php" method="POST">
                <div class="mb-3">
                    <label class="form-label">Nome</label>
                    <input name="nomeEditora" type="text" class="form-control">
                </div>
                <div class="mb-3">
                ...
                <button type="submit" class="btn btn-primary">Cadastrar nova editora</button>
            </form>
        </div>
        <div class="container">
            <h1 class="mt-5 mb-3">Editoras cadastradas</h1>
            <?php
                foreach($buscarEditoras as $editora){
                    echo "<h5><a href='editoras-detalhes.php?id=".$editora["id"]."'>".$editora["nome"]."<a> - Cidade: ".$editora["cidade"]."</h5>";
                }
            ?>
        </div>
        <!-- Footer-->
