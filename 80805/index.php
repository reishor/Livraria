    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand text-white">Livraria</li>
                <li class="sidebar-nav-item"><a href="views/editoras.php">Editoras</a></li>
                <li class="sidebar-nav-item"><a href="views/autores.php">Autores</a></li>
                <li class="sidebar-nav-item"><a href="views/livros.php">Livros</a></li>
                <li class="sidebar-nav-item"><a href="views/livro_autor.php">Livro - Autor</a></li>
            </ul>
        </nav>
        <!-- Header-->
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1 text-white">Livraria</h1>
                <h3 class="mb-5 text-white"><em>Hugo Reis | 80805</em></h3>
            </div>
        </header>
        <!-- Footer-->
